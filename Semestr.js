...
function showlection() {
    element = document.querySelector('.lections');
    element.style.visibility = 'visible';
}
function hidelection() {
    element = document.querySelector('.lections');
...
function sendcontact(){
    ...
    var colorlol = document.getElementsByTagName("contactcolor")[0];
    colorlol.style.backgroundColor = "#ffffff";
}
